...
// Styles
import getStyles from "../Styles/LoginWithEmailStyles"
                    ...
                    <View style={styles.container}>
                        <SafeAreaView style={styles.topContainer}>
                            ...
                            <View style={styles.headerContainer}>
                                <Animated.Text
                                    style={[styles.headerText, { fontSize: this.state.headerFontSize }]}>{I18n.t(TextNames.login)}</Animated.Text>
                            </View>
